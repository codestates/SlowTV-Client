    ...
    <div className="contents_page">
      ...
      <div className="contents_page_container">
        ...
        <div className="contents_page_img_list">
          {/* grass */}
          <div className="contents_page_div_img_one">
            <img
          ...
          {/* snow */}
          <div className="contents_page_div_img_two">
            <img
              className="contents_page_img"
              value="snow"
              onClick={handleOnChange}
          ...
          {/* fire */}
          <div className="contents_page_div_img_three">
            <img
              className="contents_page_img"
              value="fire"
              onClick={handleOnChange}
          ...
          {/* water */}
          <div className="contents_page_div_img_four">
            <img
              className="contents_page_img"
              value="water"
              onClick={handleOnChange}
