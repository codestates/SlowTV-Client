    ...
    <div className="landing_page">
      ...
      <div>
        <div className="landing_home" >
          ...
          <div><img src={backgroundimg1} alt="backgrdimg1" className="backgroundimg1" /></div>
          <Link className="start_link" to="/content">Get Started</Link>
        ...
        <div className="landing_bottom" src={backgroundimg2} alt="backgrdimg2" className="backgroundimg2" >
          <Link className="start_link" to="/content">Get Started</Link>
